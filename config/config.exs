...
config :gut, GutWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: GutWeb.ErrorHTML, json: GutWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Gut.PubSub,
  live_view: [signing_salt: "WGiEO98b"]
...
config :gut, Gut.Mailer, adapter: Swoosh.Adapters.Local

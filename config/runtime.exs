...
#
#     PHX_SERVER=true bin/gut start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
config :gut, page_name: System.get_env("PAGE_NAME", "gut.local")

if System.get_env("PHX_SERVER") do
  config :gut, GutWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :gut, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
